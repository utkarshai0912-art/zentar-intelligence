  ...
  return (
    <div className="w-full max-w-sm">
      <div className="mb-8 text-center">
        ...
        <h1 className="text-xl font-bold text-text-primary dark:text-dark-text-primary">Welcome back</h1>
        <p className="mt-1 text-sm text-text-secondary dark:text-dark-text-secondary">Sign in to Zentar Intelligence</p>
      </div>
